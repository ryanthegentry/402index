...
export function categorize(item) {
  ...
  if (desc.includes('mempool') || desc.includes('fee estimate') || desc.includes('on-chain fee')) return 'bitcoin'
  if (desc.includes('btc') || desc.includes('bitcoin') || desc.includes('lightning')) return 'bitcoin'
  if (desc.includes('invoice') || desc.includes('node info')) return 'bitcoin'
