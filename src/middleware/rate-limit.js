...
async function handle402(req, res) {
...
// Free tier: 100 req/min — skipped if L402 verified
...
// L402 tier: 1000 req/min — only applies if L402 verified
