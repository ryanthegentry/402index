...
server.tool('search_services', 'Search and filter paid API services in the 402 Index directory. Returns services with health status, pricing, and protocol info. Example: "Find healthy L402 weather APIs under $0.01"', {
...
server.tool('get_service_detail', 'Get full details for a single service including health check history, pricing, and schema information. Example: "Show me full details for service abc123"', {
